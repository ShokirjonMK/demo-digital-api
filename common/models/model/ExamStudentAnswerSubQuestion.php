...
class ExamStudentAnswerSubQuestion extends \yii\db\ActiveRecord
{
    ...
    public static function tableName()
    {
        ...
        if (Yii::$app->request->get('archived')) {
            return 'exam_student_answer_sub_question_23_24';
        }
        if (current_user_id() == 7656) {
            return 'exam_student_answer_sub_question_23_24';
        }
        return 'exam_student_answer_sub_question';
    }
    ...
    {
        return $this->subQuestion->ball;
    }

    public function getQuestion()
    {
        return $this->subQuestion->question;
    }
    ...
    {
        return $this->examStudentAnswer->examStudent ?? [];
    }
    ...
    {
        $this->examStudent->getAllBallChages();
