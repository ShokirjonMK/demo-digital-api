...
class PollQuestion extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['poll_id'], 'required'],
            [['poll_id', 'type', 'order', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
    ...
    {
        return $this->hasMany(PollQuestionOption::className(), ['poll_question_id' => 'id'])->onCondition(['is_deleted' => 0]);
    }
    ...
    {
        return $this->hasMany(PollUser::className(), ['poll_question_id' => 'id'])->onCondition(['is_deleted' => 0]);
    }
